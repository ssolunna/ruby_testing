...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    ...
    context 'when the previous step is 17 and the original random number is 10' do
      it 'returns 7' do
        previous_step = 17
  ...
  describe '#play' do
    ...
    context 'when the random number is 38' do
      subject(:game) { described_class.new(38) }
